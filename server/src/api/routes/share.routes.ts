...
import { createShare, finalizeShare, getShare, verifyPassword, cancelShare, getBatchShares } from '../controllers/share.controller.js';
...
router.post('/batch', getBatchShares);
