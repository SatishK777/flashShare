        ...
        {mobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-x-0 top-0 z-50 bg-[var(--bg-glass-strong)] border-b border-[var(--border-glass)] shadow-2xl p-5 md:hidden flex flex-col gap-5 max-h-[90vh] overflow-y-auto rounded-b-3xl"
            >
              {/* Drawer Header */}
